...
import { PROFILE_ACTION, GENDER_OPTION } from '../../utils/constants'
...
const Profile = () => {
    ...
    const [valueInfor, setValueInfor] = useState(
        user ? ({
            ...
            //          GENDER_OPTION.filter((gender)=>gender.value===user.user.gender)[0]:
            //         GENDER_OPTION[0]),
                                                ...
                                                <Row>
                                                    ...
                                                    <Col md={8}>
                                                        <form action="" className={styles.inforForm} onSubmit={handleUpdate}>
                                                            ...
                                                            <Button text={isUpdating ? "Lưu thông tin" : "Cập nhật"} className={styles.updateBtn}></Button>
                                                        </form>
                                                    </Col>
                                                </Row>
                                            </Container>
